...
export const ANNOTATOR_ACTIONS = [
  { key: "kill", label: "Kill", short: "K", tone: "point", apply: { kills: 1, attackAttempts: 1 } },
  { key: "attackError", label: "Error atq.", short: "AE", tone: "error", apply: { attackErrors: 1, attackAttempts: 1 } },
  { key: "attackIn", label: "Atq. en juego", short: "0", tone: "neutral", apply: { attackAttempts: 1 } },
  { key: "ace", label: "As", short: "SA", tone: "point", apply: { aces: 1 } },
  { key: "serveError", label: "Error saque", short: "SE", tone: "error", apply: { serveErrors: 1 } },
  { key: "blockSolo", label: "Bloqueo", short: "BS", tone: "point", apply: { blockSolo: 1 } },
  { key: "blockAssist", label: "Bloqueo asist.", short: "BA", tone: "point", apply: { blockAssist: 1 } },
  { key: "dig", label: "Defensa", short: "D", tone: "neutral", apply: { digs: 1 } },
  { key: "assist", label: "Asistencia", short: "A", tone: "neutral", apply: { assists: 1 } },
  { key: "receptionError", label: "Error recep.", short: "RE", tone: "error", apply: { receptionErrors: 1 } },
];
